...
export default function Events() {
    ...
    useEffect(() => {
        axios.get('https://192.168.1.11:8080/getEvents').then(res => {
        ...
        >
            {eventList.map(item => (
                    <Card>
                        ...
                        <TouchableOpacity
                            onPress={() => console.log('Successfully joined event!')}
...
//     }
//     // componentDidMount() {
//     //     fetch('http://127.0.0.1:8080/getEvents')
//     //         .then((response) => {
...
//         axios.get('http://192.168.1.11:8080/getEvents', {
//             headers: {
...
// //     />
// //
// //     <Modal visible={this.modalOpen} animationType='slide'>
// //         <View style={styles.modalContent}>
